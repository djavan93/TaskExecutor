...
public class Main {
    ...
    static ArrayList<Integer> E = new ArrayList<Integer>(Arrays.asList(0, 40)); //(0, 40));
    static ArrayList<Integer> T = new ArrayList<Integer>(Arrays.asList(1, 16)); //(1, 16, 256));
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < N.size(); i++){
            for(int j = 0; j < E.size(); j++){
                for(int k = 0; k < T.size(); k++){
                    ...
                    System.out.print(contador + " - Teste (N = " + entradas[0] + ", E = " + entradas[1] + ", T = " + entradas[2] + "): Tempo = ");
                    executor.iniciar();
                    contador++;
                }
            }
        ...
        System.out.println("Tempo gasto pelos trabalhadores para executar todos os testes: " + tempoTotal + " ms");
